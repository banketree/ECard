...
public class Edit_reflection extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_edit_reflection);
        ...
        deal_image = ImageUtil.createReflectionImageWithOrigin(zoomBitmap);
		ImageView1.setImageBitmap(deal_image);
		textView1.setText("倒影處理完畢");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.edit_reflection, menu);
		return true;
	}
